function handleFileUpload() {
    ...
    fileInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            fetch("https://coreapi.inovasolutions.ai/v1/datasets/ec5b0175-3294-4d24-b997-a58af92774bd/document/create_by_file", requestOptions)
...
function fetchAndDisplayFiles() {
    ...
    fetch("https://coreapi.inovasolutions.ai/v1/datasets/ec5b0175-3294-4d24-b997-a58af92774bd/documents?limit=100", requestOptions)
        .then((response) => response.json())
        .then((data) => {
            const fileList = document.getElementById('file-list');
            fileList.innerHTML = `<div class="text-blue-500 font-medium text-center">100/296 files shown</div>`; // Clear existing list
